...
<div class="col-12 col-md-12 d-flex justify-content-end">
                    <a href="<?php echo base_url().'admin/addnewcam' ?>" class="btn btn-info">
                     Add New Cam
                    </a>
                </div>
    <div class="containe mb-5">
        <h2 class="mb-4">Cam's List</h2>
        ...
        foreach($adminlist as $ad){ ?>
            <tr>
                ...
                <td>
                    ...
                    /<a href="<?php echo base_url().'admin/deletecam/'.$ad['camera_id'] ?>">Delete</a></td>
            </tr>
            <?php } ?>
    </tbody>
        </table>
