...
<?php include('includes/alert-msgs.php'); ?>        
    <form action="<?php echo base_url().'admin/addoutputdata' ?>" method="post">
    ...
    <div class="col-12 col-md-8">
     ...
     <div class="col-12 col-md-8 ">
        <div class="form-group">
            ...
            <input type="text" name="other_dispcription" required class="form-control input-ls" value=""   placeholder="write here">
        ...
        <div class="form-group">
            ...
            <input type="text" name="pin" required class="form-control input-ls" value=""   placeholder="write here">
