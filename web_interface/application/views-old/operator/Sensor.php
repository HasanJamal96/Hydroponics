...
<div class="main">
    ...
    <div class="containe mb-5">
        ...
        <thead>
         <tr><th>#</th><th>Sensor Name</th> <th>Sensor Default Value</th><th>Association output</th> 
         <!--
         <th>Action</th> 
         -->
         </tr>
            ...
            <tr>
              ...
              for($i=0; $i<count($someArray);$i++){
                ...
                echo "<br>";
                             ...
                             <td><a href="<?php echo base_url().'admin/associatinlist/'.$ad['sensor_id']; ?>" class="edit_btn" ><span class="badge badge-success">Asscociate Outpt</span></a>/<a href="<?php echo base_url().'admin/edit_sensor/'.$ad['sensor_id']; ?>" class="edit_btn" ><span class="badge badge-info">Edit</span></a>/<a href="<?php echo base_url().'admin/delete_sensor/'.$ad['sensor_id']; ?>"><span class="badge badge-danger">Delete</span></a></td>
            -->
            </tr>
            <?php } ?>
    </tbody>
