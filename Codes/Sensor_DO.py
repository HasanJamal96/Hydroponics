...
SENSOR_INFO = {
    ...
    "interface":"i2c",
    "url_purchase":["https://atlas-scientific.com/probes/dissolved-oxygen-probe/","https://atlas-scientific.com/embedded-solutions/ezo-dissolved-oxygen-circuit/","https://atlas-scientific.com/carrier-boards/electrically-isolated-ezo-carrier-board-gen-2/"],
    "url_datasheet":["https://files.atlas-scientific.com/LG_DO_probe.pdf","https://files.atlas-scientific.com/DO_EZO_Datasheet.pdf","https://files.atlas-scientific.com/electrically-isolated-ezo-carrier-board.pdf"],
    "address":"",
    "min":"",
    "max":"",
    "type":"EZO-PH"
        ...
        for x in range(self.count):
            if(self.status[x] and self.wait == False):
                if(CurrentTime - self.lastRead[x] > self.frequency[x]):
                    ...
                    if(val[0] == 'Success'):
                        sensor_value = val[1]
                        data["sensor_data"] = '[{"val":"' + sensor_value +'", "unit":"mg/L"}]'
                        value.append(data)
