...
SENSOR_INFO = {
    "name":"EC",
    "measurements_name":"electrical coductivity",
    "interface":"i2c",
    "url_purchase":["https://atlas-scientific.com/probes/conductivity-probe-k-1-0/","https://atlas-scientific.com/embedded-solutions/ezo-conductivity-circuit/","https://atlas-scientific.com/carrier-boards/electrically-isolated-ezo-carrier-board-gen-2/"],
    "url_datasheet":["https://files.atlas-scientific.com/EC_K_1.0_probe.pdf","https://files.atlas-scientific.com/EC_EZO_Datasheet.pdf","https://files.atlas-scientific.com/electrically-isolated-ezo-carrier-board.pdf"],
    "address":"",
    "min":"",
    "max":"",
    "type":"EZO-EC"
        ...
        for x in range(self.count):
            if(self.status[x] and self.wait == False):
                if(CurrentTime - self.lastRead[x] > self.frequency[x]):
                    ...
                    if(val[0] == 'Success'):
                        sensor_value = val[1]
                        data["sensor_data"] = '[{"val":"' + sensor_value +'", "unit":"uS/cm"}]'
                        value.append(data)
